...
seed_filename = os.path.join(run_dir, 'fake_seed_for_gen.txt')
init_full_filename = os.path.join(run_dir, init_filename)
parameters_full_filename = os.path.join(run_dir, parameters_filename)
#
...
problem, problem_filename = csd.pkl_mrjob_problem(
    ...
    image_save_str=image_save_str, dir=run_dir)
